          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 px-2">
            <div className="relative bg-gray-900 rounded-2xl shadow-xl w-full max-w-md mx-auto p-6 md:p-8 animate-fadeIn">
              ...
              {!success
                ? (
                    <>
                      <h2 className="text-2xl md:text-3xl font-bold text-center mb-2 text-orange-400">
                        Refer a Friend, Earn $50!
                      </h2>
                      <p className="text-base md:text-lg text-center text-gray-200 mb-6">
                        Love your website? Refer another small business! If your
                        friend gets their website made with us, you'll get $50 as a
                        thank you. Reward is only given for successful referrals (when
                        your friend becomes a client).
                      </p>
